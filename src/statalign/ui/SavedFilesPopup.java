...
public class SavedFilesPopup extends JDialog implements ActionListener {

	/**
	 * 
	 */
	private static final long serialVersionUID = 1L;
	static String text = "All output files have been saved to the location ";
	JButton okButton;
	
	public static void showPane(JFrame owner) {
		JOptionPane.showMessageDialog(owner, printed(text) + PPFold.outDir + " in your current directory.");
	}
	
	public SavedFilesPopup(JFrame owner) {
		super(owner, "Files Saved", true);
